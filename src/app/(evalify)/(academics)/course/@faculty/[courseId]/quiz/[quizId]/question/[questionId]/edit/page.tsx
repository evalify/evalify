...
export default function EditQuizQuestionPage() {
    ...
    const routeParams = useParams<{ courseId: string; quizId: string; questionId: string }>();
    const courseId = Array.isArray(routeParams.courseId)
        ? routeParams.courseId[0]
        : routeParams.courseId;
    const quizId = Array.isArray(routeParams.quizId) ? routeParams.quizId[0] : routeParams.quizId;
    const questionId = Array.isArray(routeParams.questionId)
        ? routeParams.questionId[0]
        : routeParams.questionId;

    const enabled = !!courseId && !!quizId && !!questionId;
