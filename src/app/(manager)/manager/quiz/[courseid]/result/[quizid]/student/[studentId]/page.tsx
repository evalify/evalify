...
export default function StudentResultPage() {
                                ...
                                <>
                                    {studentResponse.remarks && (
                                        <div className="bg-blue-50 rounded-lg p-4 dark:bg-blue-900/20">
                                            ...
                                            <pre className="break-words overflow-auto max-h-96 whitespace-pre-wrap w-full">
                                                {studentResponse.remarks ||
                                    ...
                                    {studentResponse.breakdown && (
                                        <div className="bg-green-50 rounded-lg p-4 dark:bg-green-900/20">
                                            ...
                                            <div className="prose dark:prose-invert prose-sm max-w-none break-words overflow-hidden max-h-96 text-wrap">
                                                <ReactMarkdown>
                                                    {studentResponse
                                                        .breakdown ||
    ...
    return (
        <div className="container mx-auto px-4 py-8 space-y-8 overflow-scroll">
            <Button
                variant="ghost"
                onClick={() => router.back()}
                className="mb-4"
                        ...
                        <div className="space-y-4">
                            ...
                            {question.explanation && (
                                <div className="mt-4 pt-4 border-t">
                                    ...
                                    <div className="mt-2 break-words overflow-auto max-h-96">
                                        <TiptapRenderer
                            ...
                            {/* Marks section */}
                            <div className="flex mt-4 pt-4 border-t justify-between items-center flex-wrap gap-2">
