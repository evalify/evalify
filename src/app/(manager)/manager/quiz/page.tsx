      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push(`/manager/quiz/${quiz.id}`)}
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push(`/manager/quiz/result/${quiz.id}`)}
            className="dark:bg-slate-700/50 dark:hover:bg-slate-600/50"
          >
                            ...
                            <TableCell>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="dark:bg-slate-800 dark:border-slate-700">
                                  ...
                                  <DropdownMenuItem onClick={() => router.push(`/manager/quiz/${quiz.id}`)} className="dark:hover:bg-slate-700">
                                    <SquareChartGantt className="h-4 w-4 mr-2" />
                                    Questions
                                  </DropdownMenuItem>
                                  <DropdownMenuItem onClick={() => router.push(`/manager/quiz/result/${quiz.id}`)} className="dark:hover:bg-slate-700">
