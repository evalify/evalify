...
export const latexTemplates: LatexTemplateCategory[] = [
    {
        ...
        templates: [
            ...
            },
            {
                ...
                template: "\\dfrac{\\displaystyle numerator}{\\displaystyle denominator}",
                example: "\\dfrac{\\displaystyle \\sum_{i=1}^{n} i}{\\displaystyle n^2}",
            },
            {
                name: "Square Root",
    ...
    },
    {
        ...
        templates: [
            ...
            },
            {
                ...
                template: "\\begin{pmatrix} a \\\\ b \\\\ c \\\\ \\vdots \\\\ d \\end{pmatrix}",
                example: "\\begin{pmatrix} 1 \\\\ 2 \\\\ 3 \\\\ 4 \\end{pmatrix}",
            },
            {
                name: "Matrix 2×2",
            ...
            },
            {
                ...
                example: "\\begin{pmatrix} 1 & 2 & 3 \\\\ 4 & 5 & 6 \\\\ 7 & 8 & 9 \\end{pmatrix}",
            },
            {
            ...
            },
            {
                ...
                example: "\\begin{pmatrix} 1 & 2 & 3 & | & 4 \\\\ 5 & 6 & 7 & | & 8 \\end{pmatrix}",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        templates: [
            ...
            },
            {
                ...
                template: "\\displaystyle\\int_{lower}^{upper} {expression} \\, d{variable}",
        ...
        templates: [
            {
                ...
                template: "\\begin{cases} equation1 \\\\ equation2 \\\\ equation3 \\end{cases}",
            ...
            },
            {
                ...
                example: "\\begin{aligned} f(x) &= x^2 \\\\ g(x) &= \\frac{1}{x} \\end{aligned}",
            },
        ],
    },
];
